...
@Composable
fun MainView(matches: List<MatchDomain>, onNotificationClick: NotificationOnClick) {
...
fun Notification(match: MatchDomain, onClick: NotificationOnClick) {
    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
        ...
        Image(
            ...
            contentDescription = if (match.notificationEnabled) "Imagem notificação ativada"
            else "Imagem notificação inativada"
        )
    }
}
